...
import 'package:apptodolist/const/colors.dart';
import 'package:apptodolist/data/firestor.dart';
import 'package:apptodolist/model/notes_model.dart';
import 'package:apptodolist/screen/edit_screen.dart';
...
class _Task_WidgetState extends State<Task_Widget> {
  final firestoreDatasource = FirestoreDatasource(); // Déplacez la déclaration ici
                      ...
                      children: [
                        ...
                        Checkbox(
                          ...
                          onChanged: (value) {
                            ...
                            firestoreDatasource.isDone(widget._note.id, isDone); // Utilisez la méthode à partir d'ici
                          },
                        )
                      ],
                    ),
